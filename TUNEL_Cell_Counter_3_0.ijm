...
// Revision version: 3.0 - 07/14/2016
...
// RESULT ARRAY
	var Ratio_Green_ONL = 0;
	var Ratio_Green_INL = 0;
	var Ratio_Green_Manual = 0;
	var Ratio_Red_ONL = 0;
	var Ratio_Red_INL = 0;
	var Ratio_Red_Manual = 0;
...
function Results_Array() {
	...
	Ratio_Green_ONL = ONL_Green_Count/ONL_Area_mm;
	Ratio_Green_INL = INL_Green_Count/INL_Area_mm;
	Ratio_Green_Manual = Manual_Green_Count/Manual_Area_mm;
	Ratio_Red_ONL = ONL_Red_Count/ONL_Area_mm;
	Ratio_Red_INL = INL_Red_Count/INL_Area_mm;
	Ratio_Red_Manual = Manual_Red_Count/Manual_Area_mm;
	...
	setResult("Green Cells/ONL Area (cells/mm2)", 0, Ratio_Green_ONL);
	setResult("Green Cells/INL Area (cells/mm2)", 0, Ratio_Green_INL);
	setResult("Green Cells/Manual Area (cells/mm2)", 0, Ratio_Green_Manual);
	setResult("Red Cells/ONL Area (cells/mm2)", 0, Ratio_Red_ONL);
	setResult("Red Cells/INL Area (cells/mm2)", 0, Ratio_Red_INL);
	setResult("Red Cells/Manual Area (cells/mm2)", 0, Ratio_Red_Manual);	
	...
	Result_Array = newArray("Image", "Green Cells/ONL Area (cells/mm2)", "Green Cells/INL Area (cells/mm2)", "Green Cells/Manual Area (cells/mm2)", "Red Cells/ONL Area (cells/mm2)", "Red Cells/INL Area (cells/mm2)", "Red Cells/Manual Area (cells/mm2)", "Native Spatial Scale (pixels/microns)", "Threshold Sensitivity", "Minimum Cell Size (microns)", "Maximum Cell Size (microns)", "Cell Roundness", "ONL Area (mm2)", "INL Area (mm2)", "Manual Area (mm2)", "Red Cells ONL (count)", "Red Cells INL (count)", "Red Cells Manual Area (count)", "Green Cells ONL (count)", "Green Cells INL (count)", "Green Cells Manual Area (count)");
